...
unsigned short TxHistogram[TXFIFOSIZE]; // collected before put
...
//-------------------------SCI0_OutChar------------------------
// Wait for fifo to have room, output 8-bit to serial port
// interrupt synchronization
// Input: 8-bit data to be transferred
// Output: none
void SCI0_OutChar(char data){
  TxHistogram[TxFifo_Size()]++;    // analysis of FIFO 
...
interrupt 20 void Sci0Handler(void){ char data; 
  if(SCI0SR1 & RDRF){ 
    ...
    RxFifo_Put(SCI0DRL); // clears RDRF
  }
